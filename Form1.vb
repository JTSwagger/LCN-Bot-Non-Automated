...
"Yugo"}
	...
	Public Function getModel(vnum As Integer) As Boolean
		Thread.Sleep(300)
		...
		Catch
			Do Until local_browser.FindElementById("Vehicle-model").Displayed = True
				' do nothing
			Loop
			selectElement = New SelectElement(local_browser.FindElementById("vehicle-model"))
		...
		For Each word As String In stringlist
			...
			For j As Integer = 0 To stringlist.Count - 1
				If j = whereami Then
					Continue For
				End If
				biggest = check_string(word, stringlist(j))
			Next
			whereami += 1
		Next
	...
	Function check_string(merf As String, check As String) As String
	...
	Public Sub rolltheclip(clipname As String)
	...
	Dim ymm_click As Boolean = False
	...
	Private Sub Button3_Click_3(sender As Object, e As EventArgs) Handles btnYAAAAAS.Click
		...
		ElseIf clipnum(3) = 1 Then
			rolltheclip("c:\soundboard\cheryl\REACTIONS\uh-huh 1.mp3")
			clipnum(3) += 1
		Else
			rolltheclip("C:\Soundboard\Cheryl\REACTIONS\yeah 1.mp3")
			clipnum(3) = 0
		End If
	...
	Private Sub Button7_Click_1(sender As Object, e As EventArgs) Handles btnNahhh.Click
		...
		ElseIf clipnum(4) = 1 Then
			rolltheclip("c:\soundboard\cheryl\REACTIONS\no way 1.mp3")
			clipnum(4) += 1
		Else
			rolltheclip("C:\Soundboard\Cheryl\REACTIONS\no, not at all 1.mp3")
			clipnum(4) = 0
